...
List.REDu <- readRDS(paste0("//cifs.wistar.upenn.edu/Tian/linux/lwang/drive/project/21029-07/allJTE_06_07/FoSpm/result/cellType/List.REDu_HepG2vHeLa.RData"))
List.REDi <- readRDS(paste0("//cifs.wistar.upenn.edu/Tian/linux/lwang/drive/project/21029-07/allJTE_06_07/FoSpm/result/cellType/List.REDi_HepG2vHeLa.RData"))
